# Generated by Powerlevel10k configuration wizard on 2024-10-15 at 20:48 CST.
...
() {
  ...
  typeset -g POWERLEVEL9K_ANACONDA_CONTENT_EXPANSION='${${${CONDA_PROMPT_MODIFIER#\(}% }%\)} (${P9K_ANACONDA_PYTHON_VERSION})'
